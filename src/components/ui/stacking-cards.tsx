...
// Source: https://fancycomponents.dev/docs/components/blocks/stacking-cards
//
// Adapted for this project:
//  - imports from `framer-motion` (already a dependency) rather than `motion/react`
//  - honours prefers-reduced-motion by holding scale at 1
...
const StackingCardItem = ({
  ...
  const animatedScale = useTransform(progress, rangeScale, [1, scaleTo]);
  // Cards still stack and pin; only the shrink-as-you-scroll is dropped.
  const scale = reduceMotion ? 1 : animatedScale;
